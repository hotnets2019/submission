...
#For faster simulation.
    global ns link_rate myAgent load
    $self instvar tcps tcpr;# Sender TCP,  Receiver TCP
    ...
    if {[string compare $myAgent "Agent/TCP/FullTcp/Sack/MinTCP/DelayTransport"] == 0 || [string compare $myAgent "Agent/TCP/FullTcp/Sack/DDTCP"] == 0} {
        $tcps set-file-delays "./websearch_pfabric_remainingsize_[expr round(100 * $load)]/flow.tr"
        $tcps set-file-delays "./websearch_pfabric_remainingsize_[expr round(100 * $load)]/flow.tr"
    }
