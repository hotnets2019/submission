...
Agent/TCP/FullTcp/Sack/MinTCP/DelayTransport set maximum_slack_ 6.4e-4
Agent/TCP/FullTcp/Sack/MinTCP/DelayTransport set link_speed_ $link_rate
...
} elseif {[string compare $sourceAlg "Delay"] == 0} {
    Agent/TCP set ecnhat_ true
    Agent/TCPSink set ecnhat_ true
    Agent/TCP set ecnhat_g_ $DCTCP_g
    Agent/TCP set lldct_ false
    set myAgent "Agent/TCP/FullTcp/Sack/MinTCP/DelayTransport";
